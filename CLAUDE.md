...
| `.claude/skills/security-audit/run.sh` | 71 contrôles de sécurité, référence **71 PASS / 0 FAIL** |
...
Outillage spécifique à Claude Code : skills `.claude/skills/`, sous-agents `.claude/agents/`, commandes `/audit` `/ship` `/council` `/upgrade-deps`.
